  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Alumnos Cuarto Año</li>
      </ol>
    </section>
                  ...
                  foreach ($alumnos as $key => $value) {
                    ...
                    echo '<tr>
                          ...
                          if ($value["estado"] != 0) {
                                ...
                                echo '<td><button class="btn btn-success btn-xs" tabla="cuarto" idAlumno="'.$value["id"].'" estadoAlumno="0">Activado</button></td>';

                            }else{

                                echo '<td><button class="btn btn-danger btn-xs" tabla="cuarto" idAlumno="'.$value["id"].'" estadoAlumno="1">Desactivado</button></td>';
                            }
                          ...
                          echo '<td>
                            ...
                            if ($_SESSION["perfil"] != "Preceptor") {
                                ...
                                echo'<button class="btn btn-warning btnEditarAlumno" tabla="cuarto" idAlumno="'.$value["id"].'" data-toggle="modal" data-target="#modalEditarAlumno"><i class="fa fa-pencil"></i></button>

                                  <button class="btn btn-danger btnEliminarAlumno" curso="cuarto" idAlumno="'.$value["id"].'"><i class="fa fa-times"></i></button>';

                            }


                               echo'<button class="btn btn-primary btnImprimirInformeCo4" periodo="'.$_SESSION['periodo'].'" informe="informeco4" tabla="cuarto" modalidad="'.$value["modalidad"].'" idAlumno="'.$value["id"].'" data-toggle="modal" data-target="#modalImprimirInformeCb"><i class="fa fa-print"></i></button>';
